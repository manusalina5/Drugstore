function validate(event) {
    ...
    //razon social
    if (razonsocial.value.length < 3) {
        alert.classList.remove("no-alerta");
        alert.classList.add("alerta");
        alert.innerHTML += 'El campo "Razon Social" debe tener al menos 3 caracteres.<br>';
        esValido = false;
    }
    //documento
    ...
    //razon social
    if (!/^[A-Za-zÁÉÍÓÚáéíóúñÑ\s]+$/.test(razonsocial.value)) {
        alert.classList.remove("no-alerta");
        alert.classList.add("alerta");
        alert.innerHTML += 'El campo "Razón Social" solo debe contener letras y espacios.<br>';
        esValido = false;
    }
    //documento
    ...
    //razon social
    if (razonsocial.value.trim() !== razonsocial.value) {
        alert.classList.remove("no-alerta");
        alert.classList.add("alerta");
        alert.innerHTML += 'El campo "Razón Social" no debe comenzar ni terminar con espacios.<br>';
        esValido = false;
    }
    //documento
    ...
    //razon social
    if (/["'<>]/.test(razonsocial.value)) {
        alert.classList.remove("no-alerta");
        alert.classList.add("alerta");
        alert.innerHTML += 'El campo "Razón Social" contiene caracteres no permitidos.<br>';
        esValido = false;
    }
    //documento
